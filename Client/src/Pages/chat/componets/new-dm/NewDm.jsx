...
function NewDm() {
    ...
    const [openNewContactModel, setNewContactModel] = useState(false);
    ...
    return (
        <>
            <Tooltip>
                <TooltipTrigger>
                    <FaPlus
                        ...
                        onClick={() => setNewContactModel(true)}
                    />
                </TooltipTrigger>
            ...
            <Dialog open={openNewContactModel} onOpenChange={setNewContactModel}>
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                    ...
                    <>
                        {
                            searchedContacts.length <= 0 &&
                            <div className="flex-1 md:flex  flex-col justify-center items-center duration-100 transition-all">
                                <Lottie
