...
import { LOGIN_ROUTES, SIGN_ROUTES } from '@/utils/constants';
...
function AuthPage() {
    ...
    const handleLogin = async () => {
        if (validateLogin) {
            try {
                const responce = await apiClient.post(LOGIN_ROUTES,
                    { email, password },
                    { withCredentials: true }
                );
                const userData = responce.data.user;
                if (userData.id) {
    ...
    const handleSignup = async () => {
        if (validateSignup()) {
            try {
                const responce = await apiClient.post(SIGN_ROUTES,
                    { email, password },
                    { withCredentials: true }
                );
